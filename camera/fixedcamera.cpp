...
glm::mat4x4 FixedCamera::getProjectionMatrix() const {
    return m_projectionMatrix;
}

glm::mat4x4 FixedCamera::getViewMatrix() const {
    return m_viewMatrix;
}

glm::mat4x4 FixedCamera::getTransformationMatrix() const {
    return m_transformMatrix;
}

glm::mat4x4 FixedCamera::getScaleMatrix() const {
    return m_scaleMatrix;
}

float FixedCamera::getAspectRatio() const {
    return m_aspectRatio;
}

float FixedCamera::getHeightAngle() const {
    return glm::degrees(m_thetaH);
}

float FixedCamera::getNear() const {
    return m_near;
}

float FixedCamera::getFar() const {
    return m_far;
}

void FixedCamera::setAspectRatio(float a)
{
    m_aspectRatio = a;
    updateProjectionMatrix();
    return;
...
void FixedCamera::setHeightAngle(float h) {
    m_thetaH = glm::radians(h);
    updateProjectionMatrix();
    return;
}

//glm::vec4 FixedCamera::getPosition() const {
//    return m_eye;
//}

//glm::vec4 FixedCamera::getLook() const {
//    return m_look;
//}

//glm::vec4 FixedCamera::getUp() const {
//    return m_up;
//}

void FixedCamera::orientLook(const glm::vec4 &eye, const glm::vec4 &look, const glm::vec4 &up) {
    m_eye = eye;
...
//void FixedCamera::translate(const glm::vec4 &v) {
//    m_eye += v;
...
//void FixedCamera::rotateU(float degrees) {
...
//void FixedCamera::rotateV(float degrees) {
//    float rad = -glm::radians(degrees);
//    float cosine = glm::cos(rad);
//    float sine = glm::sin(rad);
...
//void FixedCamera::rotateW(float degrees) {
//    float rad = -glm::radians(degrees);
//    float cosine = glm::cos(rad);
//    float sine = glm::sin(rad);
...
//void FixedCamera::rotate(mat4 &rotationMatrix) {
...
//void FixedCamera::setClip(float nearPlane, float farPlane) {
...
void FixedCamera::updateProjectionMatrix() {
...
void FixedCamera::updateViewMatrix() {
